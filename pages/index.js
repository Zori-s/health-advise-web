  ...
  return (
    <div className="w-screen h-screen flex ">
     ...
     <div className="w-full  md:w-[calc(40%)] bg-[#8AAEB1] flex flex-col ">
        ...
        <form className="max-w-[320px] w-full p-0 mt-2 mx-auto">
          <div>
            <button className=" text-blue-900 font-bold
             justify-end">Бүртгэл үүсгэх</button>
            </div>
            <div className="mt-40">
              ...
              <div>
                <input className="w-full bg-gray-200 mt-2 p-1 focus: border-gray-400 focus:bg-white focus:outline-none" type="text" placeholder="Нэвтрэх нэр" />
              </div>
              <div>
                <input className="w-full bg-gray-200 mt-2 p-1 focus: border-gray-400 focus:bg-white focus:outline-none" type="password" placeholder="Нууц үг" />
              </div>
